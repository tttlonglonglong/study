    ...
    <div class="container">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span> 发现页banner广告 </span>
                <router-link class="pull-right el-button el-button--primary el-button--small" :to="{ path:'/shopAdvert/create'}">添加</router-link>
            </div>
...
export default {
    ...
    methods: {
        ...
        exportTable() {
            return this.exportAppAdvertData(3);
        },
        selection(checkeds) {
    ...
    created(){
        this.$store.commit('SET_AD_TYPE','3')
    },
    mounted() {
        this.getAppAdvertList({
            page: 1
