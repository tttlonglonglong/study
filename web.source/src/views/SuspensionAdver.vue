    ...
    <div class="container">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span> 悬浮框广告 </span>
                <router-link class="pull-right el-button el-button--primary el-button--small" :to="{ path:'/suspension/create'}">添加</router-link>
            </div>
...
export default {
    ...
    methods: {
        ...
        exportTable() {
            return this.exportAppAdvertData(4);
        },
        selection(checkeds) {
    ...
    created(){
        this.$store.commit('SET_AD_TYPE','4')
    },
    mounted() {
        this.getAppAdvertList({
            page: 1,
