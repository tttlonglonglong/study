    ...
    <div class="container">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span> 钥匙banner广告 </span>
                <router-link class="pull-right el-button el-button--primary el-button--small" :to="{ path:'/keyAdvert/create'}">添加</router-link>
            </div>
...
export default {
    ...
    created(){
        this.$store.commit('SET_AD_TYPE','1')
    },
    mounted() {
        this.getAppAdvertList({
            page: 1,
