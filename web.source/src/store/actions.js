 ...
 */
export const checkAuth = ({ state, commit }, auth) => {
  let auths = Object.values(state.admin.muser.auths || {})
  return auths.findIndex(i=> i == auth) > -1  
}
// 登录
export const hideMessage = ({commit}) => {
